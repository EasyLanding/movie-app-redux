...
const MovieContentCookie = ({ toggleTabSearch, changeRateMovie, idxCookie }) =>
{
    const storageRaitingNumber = (item) =>
    {
        let ratingColor
    ...
    const storageShortDescription = (item) =>
    {
        let maxLength = 28;
    ...
    const getCookieValueByName = (name = idxCookie) =>
    {
